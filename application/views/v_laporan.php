	...
	<div id="content-wrapper" class="d-flex flex-column">
		...
		<div id="content">
			...
			<div class="container-fluid">
				<h1 class="text-center font-weight-bold">LAPORAN</h1>
				<hr>
				<div class="card shadow mt-2 mb-4">
					...
					<div class="card-body">
						<div class="table-responsive">
							<?php foreach ($simpananpokok as $key) { ?>
								<b>Simpanan pokok anda:</b>
								<b class="font-weight-bold text-success mb-2">
									Rp <?php echo number_format($key->nominal,
											2, ',', '.') ?></b> <?php } ?> &nbsp;&nbsp;
							<b>Total Pinjaman: </b>
							<?php
							foreach ($totalPinjaman as $total) { ?>
								<b class="font-weight-bold text-success">Rp <?php echo number_format($total->total, 2,
											',', '.') ?></b> <?php } ?>&nbsp;&nbsp;
							<b>Total Angsuran: </b>
							<?php
							foreach ($totalAngsuran as $total) { ?>
								<b class="font-weight-bold text-success">Rp <?php echo number_format($total->total, 2,
											',', '.') ?></b> <?php } ?>&nbsp;&nbsp;
							<b>Total Simpanan Wajib: </b>
							<?php
							foreach ($totalSimpananWajib as $total) { ?>
								<b class="font-weight-bold text-success">Rp <?php echo number_format($total->jml_simpanan, 2,
											',', '.') ?></b> <?php } ?><br>
							<b>Total Simpanan Sukarela: </b>
							<?php
							foreach ($totalSimpananSukarela as $total) { ?>
								<b class="font-weight-bold text-success">Rp <?php echo number_format($total->jml_simpanansukarela, 2,
											',', '.') ?></b> <?php } ?>
						</div>
					</div>
				</div>
								...
								<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
									...
									foreach ($dataangsuran as $data) {
										...
										<tr align="center">
											...
											<td><?php echo $data->tanggal_angsuran; ?></td>
											<td align="center"><a
														href="<?= base_url() . 'index.php/Angsuran/editangsuran/' . $data->id_angsuran; ?>"
