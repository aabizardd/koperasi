...
foreach ($pinjaman as $data) {
    ?>
        ...
        echo $data->tenor;
                                            ...
                                            <div class="btn-group">
                                                <td>
                                                    <a href="<?php echo base_url() . 'index.php/Pinjaman/editPinjaman/' . $data->id_pinjaman; ?>"
                                                        class="btn btn-primary">Edit</a>
                                                    <?php }?>
                                                    <?php if ($data->angsuran <= 0 and $data->status == 'Accepted') {?>
                                                    <a href="<?php echo base_url() . 'index.php/Pinjaman/cetak_resi/' . $data->id_pinjaman; ?>"
                                                        class="btn btn-primary">Resi</a>
                                                    ...
                                                    <?php } else if ($data->status == 'Accepted') {?>
                                                    <a href="<?php echo base_url() . 'index.php/Angsuran/bayar/' . $data->id_pinjaman ?> "
                                                        class="btn btn-primary">Setor</a>
                                                    <?php
} else {?>
