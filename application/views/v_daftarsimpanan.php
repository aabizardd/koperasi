  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <center><h1 class="text-gray-800"><b>RIWAYAT SIMPANAN SUKARELA</b></h1></center>
        <hr><hr>   
        <a href="<?= base_url().'index.php/Simpanan/ambilSimpanan/'.$this->session->id_anggota;?>" class="btn btn-success">Ambil Simpanan</a><br><br>
        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
          <thead align="center">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-gray-800">Tanggal Simpan</th>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
												<a href="<?= base_url().'index.php/Simpanan/editsimpanan/'.$data->id_simpanan;?>"
												   class="btn btn-primary">Edit</a>
												&nbsp;
												<a href="<?= base_url().'index.php/Simpanan/bukti_simpanan/'.$data->id_simpanan;?>" class="btn btn-success">Bukti</a>
											</td>
                                        </tr>
                                    <?php $i++; ?>
                                    <?php }?>
