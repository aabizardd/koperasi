				...
				<div class="container-login100">
					<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
						<center>
							...
							<hr>
							<hr>
							<form action="<?= base_url() ?>index.php/Pinjaman/updatePinjaman" method="POST"
										...
										<div class="form-group">
											<tr>
												<input type="hidden" name="id_pinjaman"
													   ...
													   value="<?php echo $p->id_pinjaman ?>"></td>
											</tr>
										</div>
										<div class="form-group">
											<tr>
												<td>Jumlah Pinjaman</td>
												<td><input type="text" name="jml_pinjaman"
														   class="form-control form-control-user"
														   value="<?php echo $p->jml_pinjaman ?>"></td>
											</tr>
										</div>
										<div class="form-group">
											<tr>
												<td>Tanggal Pinjam</td>
												<td><input type="date" name="tgl_pinjaman"
														   class="form-control form-control-user"
														   value="<?php echo $p->tgl_pinjaman ?>"></td>
											</tr>
										</div>
										<div class="form-group">
											<tr>
												<td>Lama Pinjaman</td>
												<td><input type="date" name="tenor"
														   class="form-control form-control-user"
														   value="<?php echo $p->tenor ?>"></td>
											</tr>
										</div>
										<div class="form-group">
											<tr>
												<td>Bunga %</td>
												<td><input type="number" name="bunga"
														   class="form-control form-control-user"
														   value="<?php echo $p->bunga ?>"></td>
											</tr>
										</div>
										<tr>
											<td></td>
											<td align="center">
												<input type="submit" name="submit"
													   class="btn btn-success btn-user btn-block" value="Edit"
													   style="width: 100%">
											</td>
										</tr>
									</table>
