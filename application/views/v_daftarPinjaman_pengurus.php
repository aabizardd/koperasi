	...
	<div id="content-wrapper" class="d-flex flex-column">
		...
		<div id="content">
			...
			<div class="container-fluid">
				<center><h1><b>DAFTAR PINJAMANs</b></h1></center>
				<hr>
				<hr>
				</table>
				...
				<div class="card shadow mb-4">
					<div class="card-header py-3">
						<h6 class="m-0 font-weight-bold text-primary">DataTables Examasde</h6>
					</div>
					<div class="card-body">
							...
							<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
								...
								foreach ($pinjaman as $data) {
									...
									<tr>
										...
										<td>Rp<?php if ($data->angsuran <= 0) {
												echo "0";
											} else {
												echo $data->jml_pinjaman;
											} ?></td>
										...
										<td>Rp<?php echo $data->angsuran; ?></td>
										<td>Rp<?php echo $data->denda; ?></td>
										<td><?php echo $data->status; ?></td>
										<td>
											<a href="<?php echo base_url() . 'index.php/Pinjaman/denda/' . $data->id_pinjaman; ?> "
											   class="btn btn-primary">Denda</a></td>
									</tr>
									<?php $i++; ?>
								<?php } ?>
								</tbody>
