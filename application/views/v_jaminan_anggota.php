									...
									<div class="card-body">
										<div class="table-responsive">
											<table class="table table-bordered" id="dataTable" width="100%"
												...
												<tr>
													<td><img src="<?php echo base_url('asset/foto/' . $data->ktp) ?>"
															 width="250" height="300"></td>
													<td><img src="<?php echo base_url('asset/foto/' . $data->bpkb) ?>"
															 width="250" height="300"></td>
													<td><img src="<?php echo base_url('asset/foto/' . $data->stnk) ?>"
															 width="250" height="300"></td>
													<td></td>
												</tr>
