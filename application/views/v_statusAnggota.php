	...
	<div id="content-wrapper" class="d-flex flex-column">
		...
		<div id="content">
			...
			<div class="container-fluid">
				<center><h1 class="text-gray-800"><b>STATUS ANGGOTA</b></h1></center>
				<hr>
				<hr>
								...
								foreach ($anggota as $data) {
									...
									<tr>
										...
										<td align="center" class="text-gray-800"><a
													href="<?= base_url() . 'index.php/Simpanan/aktifkan/' . $data->id_anggota; ?>"
													...
													class="btn btn-danger">Nonaktifkan</a></td>
