...
<html>
    ...
    <head>
        ...
        <link
            href="<?php echo base_url() . 'asset/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet' ?>">
        <!-- Themify FOnt-->
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <form
                            ...
                            action="<?php echo site_url('Login/searchStatusAnggota'); ?>" method="post">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span
                                        class="mr-2 d-none d-lg-inline text-gray-600 small"><?=$this->session->nama?></span>
                                    <img class="img-profile rounded-circle"
                                        src="<?php echo base_url('gambar/admin.png'); ?>">
                                </a>
                    ...
                    <div class="container-fluid">
                        <center>
                            <h1 class="text-gray-800"><b>STATUS ANGGOTA</b></h1>
                        </center>
                        <hr>
                        <hr>
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        <thead align="center">
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-gray-800">Alamat</th>
                                                <th class="text-gray-800">No. Handphone</th>
...
foreach ($anggota as $data) {
    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-gray-800"><?php echo $data->email; ?></td>
                                            <td class="text-gray-800"><?php echo $data->alamat; ?></td>
                                            <td class="text-gray-800"><?php echo $data->no_hp; ?></td>
                                            <td class="text-gray-800"><?php echo $data->statusnya; ?></td>
                                            <td align="center" class="text-gray-800">
                                                <a href="<?=base_url() . 'index.php/Simpanan/aktifkan/' . $data->id_anggota;?>"
                                                    onclick="return confirm('Anda Yakin Mengaktifkan Anggota ?')"
                                                    class="btn btn-success">Aktifkan</a>-<a
                                                    href="<?=base_url() . 'index.php/Simpanan/nonaktifkan/' . $data->id_anggota;?>"
                                                    onclick="return confirm('Anda Yakin Menonaktifkan Anggota ?')"
