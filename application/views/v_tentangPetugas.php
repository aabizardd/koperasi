		...
		<div id="content">
			...
			<div class="container-fluid">
				...
				<head>
					...
					<!--===============================================================================================-->
					<link rel="icon" type="izmage/png"
						  href="<?php echo base_url() . 'asset/login/images/icons/favicon.ico' ?>"/>
					<!--===============================================================================================-->
				...
				<div class="limiter">
					<div class="container ml-50">
						<div class="wrap-login100 p-l-65 p-r-55 p-t-65 p-b-50">
							<label>BUNGA BIRAENG merupakan sebuah Sistem Informasi Manajemen Koperasi Simpan Pinjam.
								Software ini dibuat untuk memudahkan transaksi simpan pinjam di koperasi uppks bunga
								biraeng. Koperasi UPPKS merupakan koperasi wanita yang terdiri dari 5 orang pengurus
								yang bertempat di Kabupaten Gowa, Sulawesi Selatan</label>
						</div>
					</div>
				</div>
