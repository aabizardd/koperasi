	...
	<div id="content-wrapper" class="d-flex flex-column">
		...
		<div id="content">
			...
			<div class="container-fluid">
				<center><h1 class="text-gray-800"><b>RIWAYAT SIMPANAN WAJIB</b></h1></center>
				<hr>
				<hr>
				<a href="<?= base_url() . 'index.php/Simpanan/ambilSimpananW/' . $this->session->id_anggota; ?>"
				   class="btn btn-success">Ambil Simpanan</a><br><br>
						...
						<div class="table-responsive">
							<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
								...
								<tr>
									...
									<th class="text-gray-800">Tanggal Simpanan</th>
								...
								foreach ($simpanan as $data) {
									...
									<tr>
										<td align="center" class="text-gray-800"><?php echo $i; ?></td>
										<td align="center" class="text-gray-800">Rp<?php echo number_format($data->nominal, 2, ',', '.') ?></td>
										<td align="center"
											class="text-gray-800"><?php echo $data->tanggal_simpanan; ?></td>
										<td align="center"
											class="text-gray-800">
											<a href="<?= base_url() . 'index.php/Simpanan/editsimpananWajib/' . $data->id_simpanan; ?>"
											   class="btn btn-primary">Edit</a>
											&nbsp;
											<a href="<?= base_url() . 'index.php/Simpanan/bukti_simpanan/' . $data->id_simpanan; ?>"
											   class="btn btn-success">Bukti</a>
										</td>
									</tr>
									<?php $i++; ?>
								<?php } ?>
