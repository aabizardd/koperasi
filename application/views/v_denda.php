				...
				<div class="container-login100">
					<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
						...
						<div class="container-fluid">
							<center><h1>Input Denda</h1></center>
							<form action="<?= base_url() ?>index.php/Pinjaman/simpan_denda" method="POST">
								<?php foreach ($pinjaman as $p) { ?>
									<table style="margin: 20px auto;">
										<tbody>
										<tr>
											<td>Jumlah Denda</td>
											<td><input type="number" name="denda"
													   class="form-control form-control-user"></td>
										</tr>
										<tr>
											<td><input type="hidden" name="id_pinjaman"
													   value="<?php echo $p->id_pinjaman ?>">
												<input type="hidden" name="jml_pinjaman"
													   value="<?php echo $p->jml_pinjaman ?>">
												<input type="hidden" name="tgl_pinjaman"
													   value="<?php echo $p->tgl_pinjaman ?>">
												<input type="hidden" name="id_anggota"
													   value="<?php echo $p->id_anggota ?>">
												<input type="hidden" name="status" value="<?php echo $p->status ?>">
												<input type="hidden" name="tenor" value="<?php echo $p->tenor ?>">
											</td>
										</tr>
