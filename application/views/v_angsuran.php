                        ...
                        <div class="container-login100">
                            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
                                <center>
                                    ...
                                    <hr>
                                    <hr>
                                    <form action="<?=base_url()?>index.php/Angsuran/aksi_bayar" method="POST"
                                        ...
                                        <table>
                                            <div class="form-group">
                                                <tr>
                                                    ...
                                                    <input type="hidden" name="angsuran"
                                                        class="form-control form-control-user"
                                                        value="<?php echo $p->angsuran ?>"></td>
                                                </tr>
                                            </div>
                                            <div class="form-group">
                                                <tr>
                                                    <td>Nominal</td>
                                                    <td><input type="number" name="nominal"
                                                            class="form-control form-control-user"
                                                            max="<?=$p->angsuran?>"></td>
                                                </tr>
                                            </div>
                                            <div class="form-group">
                                                <tr>
                                                    <td>Tanggal Bayar</td>
                                                    <td><input type="date" name="tanggal_angsuran"
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <input type="submit" name="submit"
                                                        class="btn btn-success btn-user btn-block" value="Bayar"
                                                        style="width: 100%">
                                                </td>
                                            </tr>
                                        </table>
