				...
				<div class="row">
					<div class="col-xl-4 col-lg-6">
						<div class="card shadow mb-4">
							...
							<div class="text">
								<div class="text">
									<center><img src="<?php echo base_url('gambar/anggota.png') ?>" width="100"
												 height="100"><br><br>
										<b>Jumlah Anggota = <?php foreach ($anggota

											as $key) { ?>
											<?php echo $key->jumlahAnggota; ?></b><br>
										<?php } ?>
										<b><a class="collapse-item"
											  href="<?= base_url() ?>index.php/Simpanan/lihat_anggota/<?= $this->session->id_anggota ?>"
											  style="text-decoration: none">-> Lihat Anggota <-</a></b></center>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-xl-4 col-lg-6">
						<div class="card shadow mb-4">
							...
							<div class="text">
								<div class="text">
									<center><img src="<?php echo base_url('gambar/pinjaman.png') ?>" width="100"
												 height="100"><br><br>
										<b>Jumlah Piutang = <?php foreach ($angsuran

											as $key) { ?>
											Rp<?php echo $key->total; ?></b><br>
										<?php } ?>
										<b><a class="collapse-item"
											  href="<?= base_url() ?>index.php/Pinjaman/laporan_pinjaman/<?= $this->session->id_anggota ?>"
											  style="text-decoration: none">-> Lihat Pinjaman <-</a></b></center>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-xl-4 col-lg-6">
						<div class="card shadow mb-4">
							...
							<div class="text">
								<div class="text">
									<center><img src="<?php echo base_url('gambar/simpanan.png') ?>" width="100"
												 height="100"><br><br>
										<b>Jumlah Simpanan = <?php foreach ($simpanan

											as $key) { ?>
											Rp<?php echo $key->jml_simpanan; ?></b><br>
										<?php } ?>
										<b><a class="collapse-item"
											  href="<?= base_url() ?>index.php/Simpanan/laporan_simpanan/<?= $this->session->id_anggota ?>"
											  style="text-decoration: none">-> Lihat Simpanan <-</a></b></center>
								</div>
							</div>
						</div>
					</div>
					...
					<script type="text/javascript">
						...
						function drawChart() {
							var data = google.visualization.arrayToDataTable([
								['Task', 'Hours per Day'],
								['Laki-Laki',   <?php foreach($anggota2 as $key2) { ?>
									<?php echo $key2->jumlahAnggota;?>
									<?php } ?> ],
								['Perempuan',  <?php foreach($anggota3 as $key3) { ?>
							...
							var options = {'title': 'Keanggotaan Koperasi', 'width': 550, 'height': 400};
