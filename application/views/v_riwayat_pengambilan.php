		...
		<div id="content">
			...
			<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
				...
				<form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search"
					  action="<?php echo site_url('Simpanan/searchRiwayat_Pengambilan'); ?>" method="post">
			...
			<div class="container-fluid">
				<center><h1 class="text-gray-800"><b>RIWAYAT PENGAMBILAN SIMPANAN</b></h1></center>
				<hr>
				<hr>
				<a href="<?php echo base_url() . 'index.php/Export/export_riwayatPengambilan/'; ?> "
				   class="btn btn-success">Download</a>
				<br><br>
				<div class="card shadow mb-4">
					<div class="card-header py-3">
						<h6 class="m-0 font-weight-bold text-primary">Pengambilan Simpanan</h6>
					</div>
					<div class="card-body">
						<div class="table-responsive">
							<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
								...
								<tr>
									...
									<th class="text-gray-800">Jumlah Pengambilan</th>
									<th class="text-gray-800">Tanggal Ambil</th>
								...
								foreach ($simpanan as $data) {
									...
									<tr>
										...
										<td align="right" class="text-gray-800">Rp<?php echo number_format($data->nominal,2,',','.'); ?></td>
										<td class="text-gray-800"><?php echo $data->tanggal_ambil; ?></td>
