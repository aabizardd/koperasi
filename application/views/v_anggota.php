		...
		<div id="content">
			...
			<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
				...
				<form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search"
					  action="<?php echo site_url('Login/searchAnggota'); ?>" method="post">
			...
			<div class="container-fluid">
				<center><h1 class="text-gray-800"><b>DAFTAR ANGGOTA</b></h1></center>
				<hr>
				<hr>
				<b><font size="5"> Total Anggota</b>
				<?php
				foreach ($totalAnggota

				as $total) {
				?><br/>
				<b><?php echo $total->jumlahAnggota; ?> Orang</b>
				<?php } ?></font>
				<!-- Page Heading -->
						...
						<div class="table-responsive">
							<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
								...
								<tr>
									...
									<th class="text-gray-800">NIK</th>
									<th class="text-gray-800">Jenis Kelamin</th>
									<th class="text-gray-800">No HP</th>
								...
								foreach ($anggota as $data) {
									...
									<tr>
										...
										<td class="text-gray-800"><?php echo $data->nik; ?></td>
										<td class="text-gray-800"><?php echo $data->jenis_kelamin; ?></td>
										<td class="text-gray-800"><?php echo $data->no_hp; ?></td>
										<td class="text-gray-800"><?php echo $data->alamat; ?></td>
										<td align="center" class="text-gray-800"><a
													href="<?= base_url() . 'index.php/Simpanan/hapusAnggota/' . $data->id_anggota; ?>"
													onclick="return confirm('Anda Yakin Menghapus Anggota ?')"
													class="btn btn-danger">Hapus</a><label>-</label><a
													href="<?= base_url() . 'index.php/Simpanan/jaminan_anggota/' . $data->id_anggota; ?>"
													class="btn btn-primary">Jaminan</a></td>
