		...
		<div id="content">
			...
			<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
				...
				<form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search"
					  action="<?php echo site_url('Simpanan/searchRiwayat_simpanan'); ?>" method="post">
			...
			<div class="container-fluid">
				<center><h1 class="text-gray-800"><b>RIWAYAT SIMPANAN</b></h1></center>
				<hr>
				<hr>
				<a href="<?php echo base_url() . 'index.php/Export/export_riwayatSimpanan/'; ?> "
