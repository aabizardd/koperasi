				...
				<div class="container-login100">
					<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
						...
						<div class="container-fluid">
							<center><h2>Form Ambil Simpanan</h2></center>
							<form action="<?= base_url() ?>index.php/Simpanan/simpan_ambilWajib/<?php $this->session->id_anggota ?>"
								  method="POST">
								<table style="margin: 20px auto;">
									<tbody>
									<tr>
										<td>Nominal</td>
										<td><input type="number" name="nominal" class="form-control form-control-user">
										</td>
									</tr>
									<tr>
										<td>Tanggal Ambil</td>
										<td><input type="date" name="tanggal_ambil"
												   class="form-control form-control-user"></td>
									</tr>
									<tr>
										<td><input type="hidden" name="id_anggota"
												   value="<?= $this->session->userdata('id_anggota') ?>"></td>
									</tr>
