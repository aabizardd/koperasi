				...
				<div class="row">
						...
						<div class="card shadow mb-4">
							...
							<div class="text">
								<div class="text text-gray-900">
									<center><img src="<?php echo base_url('gambar/community.png') ?>" width="100"
												 height="100"><br><br>
					...
					<div class="col-xl-4 col-lg-6">
						<div class="card shadow mb-4">
							...
							<div class="text">
								<div class="text text-gray-900">
									<center><img src="<?php echo base_url('gambar/pinjam.png') ?>" width="100"
												 height="100"><br><br>
										<b>Jumlah Piutang = 
										<?php foreach ($angsuran as $key) { ?>
											Rp<?php echo number_format($key->total,2,',','.'); ?></b><br>
										<?php } ?>
										<b><a class="collapse-item"
					...
					<div class="col-xl-4 col-lg-6">
						<div class="card shadow mb-4">
							...
							<div class="text">
								<div class="text text-gray-900">
									<center><img src="<?php echo base_url('gambar/savings.png') ?>" width="100"
												 height="100"><br><br>
										<b>Jumlah Simpanan = 
										<?php foreach ($simpanan as $key) { ?>
											Rp<?php echo number_format($key->jml_simpanan,2,',','.'); ?></b><br>
										<?php } ?>
										<b><a class="collapse-item"
