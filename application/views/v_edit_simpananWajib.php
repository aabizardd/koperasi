			...
			<div class="limiter">
				<div class="container-login100">
					<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
						<center>
							<h1><b>EDIT SIMPANAN WAJIB</b></h1>
							<hr>
							<hr>
							<form action="<?= base_url() ?>index.php/Simpanan/updateSimpananWajib" method="POST"
								  enctype="multipart/form-data">
								<?php foreach ($simpanan as $p) { ?>
									<table>
										<div class="form-group">
											<tr>
												<input type="hidden" name="id_simpanan"
													   class="form-control form-control-user"
													   value="<?php echo $p->id_simpanan ?>"></td>
											</tr>
										</div>
										<div class="form-group">
											<tr>
												<td>Jumlah Simpanan</td>
												<td><input type="text" name="nominal"
														   class="form-control form-control-user"
														   value="<?php echo $p->nominal ?>"></td>
											</tr>
										</div>
										<div class="form-group">
											<tr>
												<td>Tanggal Simpan</td>
												<td><input type="date" name="tanggal_simpanan"
														   class="form-control form-control-user"
														   value="<?php echo $p->tanggal_simpanan ?>"></td>
											</tr>
										</div>
										<tr>
											<td></td>
