			...
			<div class="limiter">
				<div class="container-login100">
					<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
						...
						<form action="<?= base_url() ?>Login/update_akun_petugas" method="POST" class="validate">
							<table style="margin: 20px auto;">
								<body>
								<tr>
									<td>Usename</td>
									<div class="form-group">
										<td><input type="hidden" name="id_petugas" class="form-control"
												   value="<?= $id_petugas ?>"><input type="text" name="username"
																					 class="form-control"
																					 value="<?= $username ?>"></td>
									</div>
								</tr>
