...
<head>
	...
	<link href="<?php echo base_url() . 'asset/vendor/datatables/buttons.bootstrap4.min.css" rel="stylesheet' ?>">
...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					<center>
						<h1 class="text-gray-800"><b>LAPORAN PINJAMAN</b></h1>
					</center>
					<hr>
					<hr>
					<br><br>
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<div class="col col-2">
								...
								<select class="custom-select mb-3" id="input-tahun">
							...
							<div class="table-responsive">
								...
								<table class="table table-bordered table-laporan" id="table-laporan" width="100%" cellspacing="0">
									<thead align="center">
										<tr>
											<th class="text-gray-800">No</th>
											<th class="text-gray-800">Nama</th>
											<th class="text-gray-800">Total Pinjaman</th>
											<th class="text-gray-800">Jumlah Pinjaman</th>
											<th class="text-gray-800">Sisa Setoran</th>
		...
		<script src="<?php echo base_url() . 'asset/vendor/datatables/dataTables.buttons.min.js' ?>"></script>
		<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jszip/3.1.3/jszip.min.js"></script>
		<script src="<?php echo base_url() . 'asset/vendor/datatables/buttons.bootstrap4.min.js' ?>"></script>
		<script src="<?php echo base_url() . 'asset/vendor/datatables/buttons.html5.min.js' ?>"></script>
		...
		<script>
			...
			var base_url = '<?php echo base_url() ?>/Pinjaman/getLaporan/all';
			$(document).ready(function() {
				$('#input-tahun').on('change', function() {
					base_url = '<?php echo base_url() ?>/Pinjaman/getLaporan/';
					var year = this.value;
					base_url += year;
					// console.log(base_url);
					laporan_table.ajax.url(base_url).load();
				});
				var laporan_table = $('.table-laporan').DataTable({
					dom: 'Bfrtip',
					buttons: [
						'excelHtml5', 'pdfHtml5'
					],
					...
					columns: [{
						...
						render: (data) => {
							...
							return formatRupiah(jml_pinjaman);
						}
					}, {
						'data': null,
						render: (data) => {
						...
						render: (data) => {
							...
							return `<a href="<?php echo base_url() . 'index.php/Angsuran/lihatAngsuran/' ?>${id_anggota}" class="btn btn-success">Lihat Angsuran</a>-<a href="<?php echo base_url() . 'index.php/Pinjaman/daftarPinjaman/' ?>${id_anggota}" class="btn btn-success">Lihat Pinjaman</a>`;
						}
					}]
				});
			});
