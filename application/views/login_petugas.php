...
<div class="limiter">
	<div class="container-login100">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
			<form class="login100-form validate-form" action="<?= base_url() ?>index.php/Login/aksi_login_petugas"
				  method="POST">
		...
		<?php } ?>
		<a href="<?= base_url() ?>index.php/Login/login"><b>Anggota? Login disini</b></a>
	</div>
</div>
