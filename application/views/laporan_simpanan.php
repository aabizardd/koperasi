	...
	<div id="content-wrapper" class="d-flex flex-column">
		...
		<div id="content">
			...
			<div class="container-fluid">
				<center><h1 class="text-gray-800"><b>LAPORAN SIMPANAN SUKARELA</b></h1></center>
				<hr>
				<hr>
				<a href="<?php echo base_url() . 'index.php/Export/export_simpanan/' ?>" class="btn btn-success">Download
					Laporan</a><br/><br>
						...
						<div class="table-responsive">
							<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
								...
								<tr>
									...
									<th class="text-gray-800">Total Simpan</th>
								...
								foreach ($simpanan as $data) {
									...
									<tr>
										...
										<td class="text-gray-800"><?php echo $data->totalsimpan; ?> kali</td>
										<td align="right" class="text-gray-800">
											Rp<?php echo number_format($data->jml_simpanan,2,',','.'); ?></td>
