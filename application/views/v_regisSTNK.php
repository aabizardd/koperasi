					...
					<div class="container-login100">
						<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
							<center><h1>- Kelengkapan -</h1>
								<hr>
								<hr>
								<h3>Upload BPKB->Upload STNK</h3>
							</center>
							<form action="<?= base_url() ?>index.php/Login/STNK_aksi" method="POST"
								  enctype="multipart/form-data">
								<table style="margin: 20px auto;">
									<tbody>
									<tr>
										<td>STNK</td>
										<td><input type="file" name="stnk" class="form-control form-control-user"
												   required=""></td>
									</tr>
