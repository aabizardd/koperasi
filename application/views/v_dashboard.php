						...
						<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
						   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							...
							<img class="img-profile rounded-circle"
								 src="<?php echo base_url('gambar/anggota1.png'); ?>">
						</a>
				...
				<div class="row">
								...
								<div class="text text-gray-900">
									<center><img src="<?php echo base_url('gambar/pinjam.png') ?>" width="100"
										...
										<b>Jumlah Pinjaman =
											...
											Rp<?php echo number_format($key->jml_pinjaman,2,',','.'); ?></b><br>
										<?php } ?>
										<b><a class="collapse-item"
											  href="<?= base_url() ?>index.php/Pinjaman/show_pinjaman/<?= $this->session->id_anggota ?>"
							...
							<div class="text ">
								<div class="text text-gray-900">
									<center><img src="<?php echo base_url('gambar/savings.png') ?>" width="100"
												 height="100"><br><br>
										<b>Simpanan Sukarela = <?php foreach ($simpanan

											as $key) { ?>
											Rp<?php echo number_format($key->jml_simpanan,2,',','.'); ?></b><br>
										<?php } ?>
										<b> Simpanan Wajib = <?php foreach ($simpananW
					...
					<div class="col-xl-4 col-lg-6">
						<div class="card shadow mb-4">
							...
							<div class="text pb-3">
								<div class="text text-gray-900">
									<center><img src="<?php echo base_url('gambar/debt (2).png') ?>" width="100"
												 height="100"><br><br>
										<b>Jumlah Utang = <?php foreach ($angsuran as $key) { ?>
											Rp<?php echo number_format($key->total,2,',','.'); ?></b><br>
										<?php } ?>
										<b><a class="collapse-item"
											  href="<?= base_url() ?>index.php/Angsuran/show_angsuran/<?= $this->session->id_anggota ?>"
											  style="text-decoration: none">-> Lihat Angsuran <-</a></b></center>
								</div>
							</div>
						</div>
					</div>
